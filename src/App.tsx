...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-transparent text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300 relative pointer-events-none">
      ...
      <div className="relative z-10 pointer-events-none flex flex-col min-h-screen">
        <header className="bg-white dark:bg-slate-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-slate-700 sticky top-0 z-20 pointer-events-auto">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex-grow pointer-events-none">
          {activeTab === 'dashboard' && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                <div className="pointer-events-auto"><Dashboard expenses={expenses} budget={budget} /></div>
              ...
              <div className="space-y-8">
                <div className="pointer-events-auto"><ExpenseForm onAddExpense={addExpense} /></div>
                <div className="pointer-events-auto"><BudgetSettings budget={budget} onUpdateBudget={updateBudget} /></div>
              </div>
            </div>
          )}

          {activeTab === 'reports' && (
            <div className="pointer-events-auto"><Reports expenses={expenses} /></div>
          )}

          {activeTab === 'advisor' && (
            <div className="max-w-3xl mx-auto">
              <div className="pointer-events-auto"><AIAdvisor expenses={expenses} budget={budget} /></div>
            </div>
          )}
